...
src_install() {
	dolib.so usr/lib/arm-linux-gnueabihf/tegra-egl/libEGL.so.1
	dosym libEGL.so.1 /usr/$(get_libdir)/libEGL.so

	dolib.so usr/lib/arm-linux-gnueabihf/tegra-egl/libGLESv1_CM.so.1
	dosym libGLESv1_CM.so.1 /usr/$(get_libdir)/libGLESv1_CM.so

	dolib.so usr/lib/arm-linux-gnueabihf/tegra-egl/libGLESv2.so.2
